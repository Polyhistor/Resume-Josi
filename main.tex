...
\begin{paracol}{2}
  \cvskill{Office Administration}{4.5}
  \divider
  \cvskill{Client Reception}{4.5}
  \divider
  \cvskill{Data Entry and Documentation}{4.5}
  \divider
  \cvskill{Scheduling and Meeting Organization}{4.5}
  \divider
  \cvskill{Multi-tasking and Confidentiality}{4.5}
  \divider
  \cvskill{Team Coordination and Management}{4.5}
  \divider
  \cvskill{Communication}{4.1}
  \divider
  \cvskill{Figma}{3}
  \divider
  \cvskill{Adobe XD}{3}
